...
var FilterList = React.createClass({displayName: "FilterList",
  filterClick: function () {
    calendarFilters.onNext({
      showOnlyDaily: document.getElementById(this.props.prefix + 'dailyFilter').checked,
      showOnlyPerformances: document.getElementById(this.props.prefix + 'performanceFilter').checked
    });
  },
  render: function () {
    return (
        React.createElement("ul", {className: "filterList"}, 
          ...
          React.createElement("li", null, 
            React.createElement("span", null, 
              React.createElement("input", {id: this.props.prefix + "datepicker", name: "datepicker", placeholder: "Custom Date"})
            )
          ), 
