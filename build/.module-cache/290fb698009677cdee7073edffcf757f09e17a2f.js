...
var EventRemainder = React.createClass({displayName: "EventRemainder",
  render: function () {
    return (
        React.createElement("div", {className: classNames('event', 'remainder')}, 
           "+ Show ", this.props.remainder, " More"
        )
    );
  }
});
...
var EventDate = React.createClass({displayName: "EventDate",
  render: function () {
    ...
    if (component.props.printAll == 'true') {
      remainder = React.createElement(EventRemainder, {remainder: remainder})
    }
    return (
