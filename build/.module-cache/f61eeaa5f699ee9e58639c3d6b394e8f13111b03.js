...
var MobileEvents = React.createClass({displayName: "MobileEvents",
  ...
  render: function () {
    var events = this.props.events.filter(function (event) {
      return event.startDate === this.state.selected;
    });
    var list = events.map(function (event, index, events) {
      var time = printTime(event);
      var venue = printVenu(eevent.venue);
      return (
          React.createElement("div", {className: classes}, 
            React.createElement("span", {className: "time"}, time), 
            React.createElement("span", {className: "title"}, event.title, " (", venue, ")")
          )
      );
    });
    return list;
  ...
  render: function () {
    ...
    return (
        React.createElement("div", null, 
          ...
          React.createElement(MobileEvents, {events: events})
        )
    );
  }
});
