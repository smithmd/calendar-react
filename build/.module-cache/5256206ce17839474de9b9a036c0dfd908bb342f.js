...
var Calendar = React.createClass({displayName: "Calendar",
  ...
  getInitialState: function () {
    return {windowWidth: window.innerWidth, data: []}
  },
  render: function () {
    var ret = null;
    if (this.state.windowWidth > 480) { ret = React.createElement(DesktopCalendar, {data: this.state.data}); }
    return (React.createElement(DesktopCalendar, {data: this.state.data}));
  }
});
