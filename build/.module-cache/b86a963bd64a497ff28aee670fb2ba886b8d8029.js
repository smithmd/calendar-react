...
var DesktopCalendar = React.createClass({displayName: "DesktopCalendar",
  ...
  render: function () {
    ...
    var eventWeeks = [];
    var maxWeeks = this.props.endingDay.diff(this.props.beginningDay, 'weeks') + 1;

    var end = this.props.beginningDay.clone();
    end.day(6);
    ...
    for (var i = 0; i < maxWeeks; i += 1) {
      ...
      eventWeeks[i] = (React.createElement(DesktopCalendarRow, {key: "w"+i, startDay: beginningDay, week: week, 
                                           month: this.state.dates.startMonth, 
...
var Calendar = React.createClass({displayName: "Calendar",
  ...
  render: function () {
    ...
    if (this.state.windowWidth > 480) {
      ret = (React.createElement(DesktopCalendar, {events: events, beginningDay: beginningDay, endingDay: endingDay}));
    } else {
