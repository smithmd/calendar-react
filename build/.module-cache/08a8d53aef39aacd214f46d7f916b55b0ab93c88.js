        ...
        React.createElement("ul", {className: "filterList"}, 
          React.createElement("li", null, 
            React.createElement("span", {onClick: this.filterClick}, 
              React.createElement("input", {id: "dailyFilter", type: "checkbox", name: "dailyFilter"}), 
              React.createElement("label", {htmlFor: "dailyFilter"}, "Daily Events")
            )
          ), 
          React.createElement("li", null, 
            React.createElement("span", {onClick: this.filterClick}, 
              React.createElement("input", {id: "performanceFilter", type: "checkbox", name: "performanceFilter"}), 
...
React.render(React.createElement(FilterList, null), document.getElementById('filters-mobile'));