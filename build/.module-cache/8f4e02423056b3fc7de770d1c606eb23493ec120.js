  ...
  render: function () {
    ...
    for (var i = 0; i < 7; i++) {
      ...
      if (this.props.week[0]) {
        ...
        day = this.props.beginningDay.day(i);
      }
...
var EventCalendar = React.createClass({displayName: "EventCalendar",
  ...
  render: function () {
    ...
    for (var i = 0; i <= 5; i++) {
      ...
      eventWeeks.push(React.createElement(EventCalendarRow, {key: "w"+i, startDay: beginningDay, week: week, month: component.state.dates.currentMonth}));
