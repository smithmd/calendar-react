...
var EventDate = React.createClass({displayName: "EventDate",
  render: function () {
    ...
    return (
        React.createElement("div", {className: classNames('day', (this.props.isCurr ? '' : 'notCurrent'))}, 
...
var EventCalendarRow = React.createClass({displayName: "EventCalendarRow",
  render: function () {
    ...
    for(var i = 0; i < 7; i++) {
      ...
      if (events.length > 0) {
        if (day != null)
          days.push(React.createElement(EventDate, {day: day.date(), key: key, isCurr: day.month() == this.props.month}));
      } else {
        if (day != null)
          days.push(React.createElement(EventDate, {day: day.date(), key: key, isCurr: day.month() == this.props.month}));
      }
