var Event = React.createClass({displayName: "Event",
  render: function () {
    ...
    return (
        React.createElement("div", {"data-startDate": this.props.event.startDate, className: classNames('event',(this.props.isLast ? 'last' : ''))}, 
...
var EventCalendarRow = React.createClass({displayName: "EventCalendarRow",
  render: function () {
    ...
    for (var i = 0; i < 7; i += 1) {
      ...
      days[i] = (React.createElement(EventDate, {events: events, displayLength: 3, day: day.date(), key: 'w'+i, 
