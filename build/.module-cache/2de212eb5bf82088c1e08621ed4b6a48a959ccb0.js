...
var EventDate = React.createClass({displayName: "EventDate",
  ...
  render: function () {
    ...
    if (component.state.printAll) {
      ...
      eventList.push(React.createElement(Event, {event: event, isLast: index === (component.props.displayLength - 1) || index === (events.length - 1), key: index}));
    }
