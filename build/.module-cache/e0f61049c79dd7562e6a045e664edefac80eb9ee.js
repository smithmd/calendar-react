...
var EventDate = React.createClass({displayName: "EventDate",
  render: function () {
    ...
    var sub = selectedDate.subscribe(this.onNext,function() {}, function () {});
    return (
...
var EventDateList = React.createClass({displayName: "EventDateList",
  ...
  componentDidMount: function () {
    ...
    window.selectedDate.subscribe(function (s) {
      ...
      React.renderComponent(React.createElement(EventDateList, null), document.getElementById('prettyEvents'));
    });
  },
  render: function () {
    var eventDateIndex = [];
