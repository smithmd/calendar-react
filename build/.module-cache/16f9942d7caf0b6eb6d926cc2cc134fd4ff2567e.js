...
var EventRemainder = React.createClass({displayName: "EventRemainder",
  render: function () {
    return (
        React.createElement("a", {href: "javascript:void(0)", onClick: this.props.clickFunc}, "+ Show ", this.props.remainder, " More")
    );
  }
});
...
var EventDate = React.createClass({displayName: "EventDate",
  ...
  render: function () {
    ...
    if (component.props.printAll == 'false' && remaining > 0) {
      remainder = React.createElement(EventRemainder, {clickFunc: this.handleMoreClick, remainder: remaining})
    }
    return (
