...
var MobileEvents = React.createClass({displayName: "MobileEvents",
  ...
  render: function () {
    ...
    var list = events.map(function (event, index) {
      var time = formatTimePhone(new Date(component.props.event.startTime));
      var meridiem = getMeridiem(new Date(component.props.event.startTime));
      ...
      return (
          React.createElement("div", {key: index, className: zebra}, 
            React.createElement("span", {className: "time"}, time, " ", meridiem), 
