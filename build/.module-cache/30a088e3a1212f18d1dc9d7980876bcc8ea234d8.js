...
var MobileDate = React.createClass({displayName: "MobileDate",
  ...
  render: function () {
    ...
    var selectedClass = (this.props.isSelected ? 'selected' : null);
    var currentMonthClass = (this.props.isCurr ? null : 'notCurrentMonth');
    ...
    return (
        React.createElement("div", {
            className: classNames('day',selectedClass,currentMonthClass), 
