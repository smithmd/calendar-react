...
var EventRemainder = React.createClass({displayName: "EventRemainder",
  render: function () {
    ...
    return (
        React.createElement("div", {onClick: click}, 
          React.createElement("a", {href: "javascript:void(0)", onClick: click}, "+ Show ", this.props.remainder, " More")
        )
    );
  }
});
...
var EventDate = React.createClass({displayName: "EventDate",
  ...
  render: function () {
    ...
    if (this.props.printAll == 'false' && remaining > 0) {
      remainder = React.createElement(EventRemainder, {onClick: this.handleMoreClick, remainder: remaining})
    }
    return (
