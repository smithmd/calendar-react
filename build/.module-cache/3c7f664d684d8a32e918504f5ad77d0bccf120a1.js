var Event = React.createClass({displayName: "Event",
  render: function () {
    var time = formatTime(new Date(event.startTime));
    return (
        React.createElement("div", {className: "event"}, 
          React.createElement("span", {className: "time"}, this.props.event)
        )
    );
  }
});
...
var EventDate = React.createClass({displayName: "EventDate",
  render: function () {
    var eventList = this.props.events.map(function (event, index) {
