...
React.render(React.createElement(FilterList, {prefix: "dsk-", maxMonths: 2}), document.getElementById('filters'));

React.render(React.createElement(FilterList, {prefix: "mob-", maxMonths: 1}), document.getElementById('filters-mobile'));