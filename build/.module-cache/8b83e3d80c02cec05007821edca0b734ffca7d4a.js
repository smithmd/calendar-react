...
var PickList = React.createClass({displayName: "PickList",
  ...
  handleClickChild: function (i, filter) {
    ...
    var obj = {};
    filter.onNext(obj[this.props.category] = tmp);
  },
  render: function () {
    var component = this;
    var list = null;
  ...
  render: function () {
    return (
        React.createElement("span", null, 
          React.createElement(PickList, {data: venues, category: "venue", title: "Venues", filter: venueFilters}), 
          React.createElement(PickList, {data: campDivisions, category: "division", title: "Camp Divisions", filter: divisionFilters}), 
          React.createElement(PickList, {data: artsAreas, category: "area", title: "Arts Area", filter: artsAreaFilters})
        )
    );
  }
});
