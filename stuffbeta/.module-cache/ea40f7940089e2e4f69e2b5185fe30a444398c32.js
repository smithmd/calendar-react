...
var SearchFilter = React.createClass({displayName: "SearchFilter",
  handleUpdate: function () {
    var text = document.getElementById(this.props.id).valueOf();
    console.log(text);
  },
  render: function () {
    return (
        React.createElement("li", null, 
          React.createElement("input", {type: "text", id: this.props.id, placeholder: "Filter on more", onkeypress: this.handleUpdate})
        )
    );
  }
});
